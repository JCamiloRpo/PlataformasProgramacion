...
namespace InCuarenTime.Controllers
{
    public class PropietariosController : Controller
    {
        ...
        public PropietariosController(InCuarenTimeContext context)
        {
            _context = context;
        }
        ...
        {
            var inCuarenTimeContext = _context.Propietario.Include(p => p.Apartamento.Unidad_Residencial);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var propietario = await _context.Propietario
                .Include(p => p.Apartamento.Unidad_Residencial)
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Telefono,Estado,ApartamentoID")] Propietario propietario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Telefono,Estado,ApartamentoID")] Propietario propietario)
        {
