...
namespace InCuarenTime.Controllers
{
    public class CiudadesController : Controller
    {
        ...
        public CiudadesController(InCuarenTimeContext context)
        {
            _context = context;
        }
        ...
        {
            var inCuarenTimeContext = _context.Ciudad.Include(c => c.Departamento);
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Estado,DepartamentoID")] Ciudad ciudad)
        {
            ...
            ViewData["DepartamentoID"] = new SelectList(_context.Departamento, "Id", "Nombre", ciudad.DepartamentoID);
            return View(ciudad);
        }
